		...
		<div class="card">
			<div class="card-body login-card-body">
				<p class="login-box-msg">
					...
					<span class="d-block text-sm">ระบบสารสนเทศเพื่อการบริหารผลการตรวจการปฏิบัติราชการ</span>
					<span class="d-block text-sm">Performance Inspection Management Information System</span>

					<span class="d-block text-danger mt-3">! สิทธิการใช้งานนี้ ไม่สามารถใช้งานได้</span>
					<a class="d-block" href="#" onclick="return window.history.back();">ย้อนกลับ</a>
				</p>
