...
<head>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?= base_url('assets/admin_lte/plugins/summernote/summernote-bs4.css') ?>">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <form class="form-inline ml-3">
                <div class="input-group input-group-sm">
                    <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" value="xxx">
